...
static const char * c3_debug_family_names[5] = { "nargin", "nargout", "u",
  "dist", "udist" };
...
static void c3_emlrt_marshallIn(SFc3_simulation2InstanceStruct *chartInstance,
  const mxArray *c3_b_udist, const char_T *c3_identifier, real_T c3_y[4]);
static void c3_b_emlrt_marshallIn(SFc3_simulation2InstanceStruct *chartInstance,
  const mxArray *c3_b_u, const emlrtMsgIdentifier *c3_parentId, real_T c3_y[4]);
static void c3_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c3_mxArrayInData, const char_T *c3_varName, void *c3_outData);
static const mxArray *c3_b_sf_marshallOut(void *chartInstanceVoid, void
  *c3_inData);
static real_T c3_c_emlrt_marshallIn(SFc3_simulation2InstanceStruct
...
static const mxArray *c3_c_sf_marshallOut(void *chartInstanceVoid, void
  *c3_inData);
static int32_T c3_d_emlrt_marshallIn(SFc3_simulation2InstanceStruct
  *chartInstance, const mxArray *c3_b_u, const emlrtMsgIdentifier *c3_parentId);
...
static uint8_T c3_e_emlrt_marshallIn(SFc3_simulation2InstanceStruct
  ...
  *c3_identifier);
static uint8_T c3_f_emlrt_marshallIn(SFc3_simulation2InstanceStruct
  *chartInstance, const mxArray *c3_b_u, const emlrtMsgIdentifier *c3_parentId);
  ...
  (SFc3_simulation2InstanceStruct *chartInstance)
{
  ...
  for (c3_i0 = 0; c3_i0 < 4; c3_i0++) {
    c3_b_u[c3_i0] = (*chartInstance->c3_udist)[c3_i0];
  }

  c3_b_y = NULL;
  sf_mex_assign(&c3_b_y, sf_mex_create("y", c3_b_u, 0, 0U, 1U, 0U, 1, 4), false);
  sf_mex_setcell(c3_y, 0, c3_b_y);
  c3_hoistedGlobal = chartInstance->c3_is_active_c3_simulation2;
  ...
  *chartInstance, const mxArray *c3_st)
{
  ...
  for (c3_i1 = 0; c3_i1 < 4; c3_i1++) {
    (*chartInstance->c3_udist)[c3_i1] = c3_dv0[c3_i1];
  }

  chartInstance->c3_is_active_c3_simulation2 = c3_e_emlrt_marshallIn
  ...
  *chartInstance)
{
  ...
  int32_T c3_i5;
  int32_T c3_i6;
  static real_T c3_y[4] = { -0.05, 0.02, 0.03, -0.01 };
  ...
  for (c3_i2 = 0; c3_i2 < 4; c3_i2++) {
    _SFD_DATA_RANGE_CHECK((*chartInstance->c3_u)[c3_i2], 0U);
  }

  chartInstance->c3_sfEvent = CALL_EVENT;
  _SFD_CC_CALL(CHART_ENTER_DURING_FUNCTION_TAG, 2U, chartInstance->c3_sfEvent);
  c3_hoistedGlobal = *chartInstance->c3_dist;
  for (c3_i3 = 0; c3_i3 < 4; c3_i3++) {
    c3_b_u[c3_i3] = (*chartInstance->c3_u)[c3_i3];
  }

  c3_b_dist = c3_hoistedGlobal;
  ...
  _SFD_SYMBOL_SCOPE_ADD_EML(&c3_b_dist, 3U, c3_b_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(c3_b_udist, 4U, c3_sf_marshallOut,
    c3_sf_marshallIn);
  CV_EML_FCN(0, 0);
  ...
  if (CV_EML_IF(0, 1, 0, c3_b_dist != 0.0)) {
    ...
    for (c3_i6 = 0; c3_i6 < 4; c3_i6++) {
      c3_b_udist[c3_i6] = c3_b[c3_i6] + c3_y[c3_i6];
    }
  } else {
    _SFD_EML_CALL(0U, chartInstance->c3_sfEvent, 6);
    for (c3_i7 = 0; c3_i7 < 4; c3_i7++) {
      c3_b_udist[c3_i7] = c3_b_u[c3_i7];
    }
  }
  ...
  for (c3_i8 = 0; c3_i8 < 4; c3_i8++) {
    (*chartInstance->c3_udist)[c3_i8] = c3_b_udist[c3_i8];
  }
  ...
  for (c3_i9 = 0; c3_i9 < 4; c3_i9++) {
    _SFD_DATA_RANGE_CHECK((*chartInstance->c3_udist)[c3_i9], 1U);
  }

  _SFD_DATA_RANGE_CHECK(*chartInstance->c3_dist, 2U);
}
...
static const mxArray *c3_sf_marshallOut(void *chartInstanceVoid, void *c3_inData)
{
  ...
  for (c3_i11 = 0; c3_i11 < 4; c3_i11++) {
    c3_b_u[c3_i11] = c3_b_inData[c3_i11];
  }
  ...
  const mxArray *c3_b_udist, const char_T *c3_identifier, real_T c3_y[4])
{
  ...
  c3_b_emlrt_marshallIn(chartInstance, sf_mex_dup(c3_b_udist), &c3_thisId, c3_y);
  sf_mex_destroy(&c3_b_udist);
}
  ...
  *c3_mxArrayInData, const char_T *c3_varName, void *c3_outData)
{
  ...
  SFc3_simulation2InstanceStruct *chartInstance;
  chartInstance = (SFc3_simulation2InstanceStruct *)chartInstanceVoid;
  c3_b_udist = sf_mex_dup(c3_mxArrayInData);
  ...
  *chartInstance, const mxArray *c3_b_u, const emlrtMsgIdentifier *c3_parentId)
{
  ...
  int32_T c3_i14;
  (void)chartInstance;
  sf_mex_import(c3_parentId, sf_mex_dup(c3_b_u), &c3_i14, 1, 6, 0U, 0, 0U, 0);
  c3_y = c3_i14;
  sf_mex_destroy(&c3_b_u);
  return c3_y;
}
  ...
  *chartInstance)
{
  chartInstance->c3_u = (real_T (*)[4])ssGetInputPortSignal_wrapper
    (chartInstance->S, 0);
  chartInstance->c3_udist = (real_T (*)[4])ssGetOutputPortSignal_wrapper
    (chartInstance->S, 1);
...
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(1781509296U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(1609002971U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(2390955666U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(3834167950U);
}
...
mxArray *sf_c3_simulation2_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("fgIwnnFsjnUbLl56JII7JE");
...
static const mxArray *sf_get_sim_state_info_c3_simulation2(void)
{
  ...
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"udist\",},{M[8],M[0],T\"is_active_c3_simulation2\",}}"
  };
  ...
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    if (ssIsFirstInitCond(S) && fullDebuggerInitialization==1) {
      /* do this only if simulation is starting */
      {
        ...
        _SFD_CV_INIT_EML_IF(0,1,0,45,53,101,124);
        ...
        _SFD_SET_DATA_VALUE_PTR(1U, *chartInstance->c3_udist);
        _SFD_SET_DATA_VALUE_PTR(2U, chartInstance->c3_dist);
      }
    } else {
...
static void mdlSetWorkWidths_c3_simulation2(SimStruct *S)
{
  ...
  ssSetChecksum0(S,(754741786U));
  ssSetChecksum1(S,(863140780U));
  ssSetChecksum2(S,(2245488091U));
  ssSetChecksum3(S,(2515140999U));
